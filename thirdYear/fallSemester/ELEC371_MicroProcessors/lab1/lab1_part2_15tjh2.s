...
mainloop:
	...
	call ReadSwitches #get values from switches returns data in r3
	call WriteHexDisplays #sends data from readSwitches to writeHexDisplays in r3		
...
ReadSwitches: #reads data from switches and returns information in r3
	...
	ldwio r3, 0(r2) #load switches data into r3
...
WriteHexDisplays: #takes input data in r3 and displays data to seven-segment display
	...
	stwio r3, 0(r2) #send data from switches to seven-segment display
