...
//ADDED FOR PART 2
#define TO_STATUS		((volatile unsigned int*)  0x10004000)
#define TO_CONTROL		((volatile unsigned int*)  0x10004004)
#define TO_START_LO		((volatile unsigned int *) 0x10004008)
#define TO_START_HI		((volatile unsigned int *) 0x1000400C)
